...
console.log('init...', this, this.values('options'));
		this.element.find(" li>.liContent").on('click',function() {
			$(".jq-tree-acl li>.liContent").removeClass('active');
			$(this).addClass('active');
			return false;
		}).on('mouseenter',function() {
			$(this).addClass('currentHover');
		}).on('mouseleave',function() {
			$(".jq-tree-acl li>.liContent").removeClass('currentHover');
		});
